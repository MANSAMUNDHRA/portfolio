...
const allProjects = [
  ...
  {
    id: 3, type: "fullstack", name: "Programmer Tracker",
    tagline: "A website every programmer needs",
    year: "2025", status: "completed",
    liveDemo: "https://tracker.binny.house",
    github: "https://github.com/MANSAMUNDHRA/track_your_month_programmer",
    image: "/chatform.png",
    tags: ["Node.js", "Vanilla JS", "REST API"],
    description: `A minimalist website to track your leetcode journey, how when why. Track your DSA and projects now.`,
    techStack: ["Node.js", "Vanilla JS", "HTML/CSS", "MongoDB"],
  },
  {
    id: 4, type: "web", name: "FixMySociety",
    tagline: "Civic issue reporting platform — 2nd Prize SIH",
    year: "2024", status: "completed",
    liveDemo: "https://fixmysociety.vercel.app/",
  ...
  },
  {
    ...
    liveDemo: null,
    github: "https://github.com/MANSAMUNDHRA/StockPredictor",
    image: "/stock.jpg",
